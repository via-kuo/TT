...
class SensorPayload(BaseModel):
    ...
    @field_validator("skel_head_drop", "skel_lean_forward", "skel_shoulder_raise", mode="before")
    @classmethod
...
async def _ema_classify(r, session_id: str, p: SensorPayload) -> str:
    ...
    raw_agi = max(0.0, min(1.0, p.body_sway / max(SWAY_AGITATION_MIN, 1e-6) - 1.0))
