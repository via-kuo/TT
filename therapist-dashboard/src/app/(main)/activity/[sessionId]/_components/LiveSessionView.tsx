...
export function LiveSessionView() {
 ...
 return (
   <div className="h-screen overflow-hidden bg-[#f5e6d3] px-4 md:px-6 lg:px-8 xl:px-14 pt-3 md:pt-[9vh] lg:pt-[9vh] pb-4 flex flex-col gap-2 md:gap-3 lg:gap-4 xl:gap-5" >
